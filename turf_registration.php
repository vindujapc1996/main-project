...
if(isset($_POST['submit']))
{
  ...
  $sql="INSERT INTO `turf_registration`(`turf_name`, `turf_place`, `amount`, `payment_id`, `image`) VALUES ('$turf_name','$turf_place','$amount','0','$filenew')";
...
<body>
  ...
  <div class="card-body">
    ...
    <input type="text" name="turf_name" id="turf_name" placeholder="turf_name">
    <br>
    <br>
    <input type="text" name="turf_place" id="turf_place" placeholder="turf_place">
     <br>
     <br>
  ...
  <?php  
  $query = "SELECT payment_id FROM payment_tb";
  $result = mysqli_query($con, $query);
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
      ?>
      <option value="<?php echo $row['payment_id'];?>"><?php echo $row['payment_id'];?></option> 
      <?php 
    }
  }
  ?>
    ...
    <center> <button  name="submit" value="submit"> submit </button></center>
       ...
       <!-- <h1>Welcome to turf registration</h1>
      <h2></h2> -->
