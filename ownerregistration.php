...
mysqli_query($con,"INSERT INTO owner_registration(owner_name,address,email,contact,approval_status,image) VALUES('$owner_name','$address','$email','$contact','0','$filenew')");
$log=mysqli_insert_id($con);
$sql=mysqli_query($con,"INSERT INTO login_tb(login_id,username,password,type) VALUES('$log','$username','$hash','owner')");
if($sql)
{
  
  echo'<script>alert("registered sucessfully"); </script>';  
  ?>
  <script>window.location.assign('ownerregistration.php');</script>
  <?php
}
else
{
...
<body>
  ...
  <div class="card" style="border-radius: 6px;  background-image: url('https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Football_%28soccer_ball%29.svg/1200px-Football_%28soccer_ball%29.svg.png');">
            <div class="card-body p-9"  >
              ...
              <h2 class="text-uppercase text-center mb-5" style="color:black;">owner registration form</h2>
              ...
              <form name="myform"  method="POST" enctype="multipart/form-data" onsubmit="return valid()" required>
                  ...
                  <input type="text" id="name" name="name" onkeyup="clearmsg('sp1')"  class="form-control form-control-lg" placeholder="enter your name" /><span style="color:red;"  id="sp1"></span>
                   <br>
                   <input type="text" id="address" name="address" onkeyup="clearmsg('sp2')" class="form-control form-control-lg" placeholder="enter your address" /><span style="color:red;" id="sp2"></span>

                          <br>
        <input type="email" id="email" name="email" onkeyup="clearmsg('sp3')" class="form-control form-control-lg" placeholder="enter your mail " /><span style="color:red;" id="sp3"></span>
         <br>         
                  
     <input type="text" id="contact"  onkeyup="clearmsg('sp4')"  class="form-control form-control-lg"  name="contact" placeholder="enter your contact" /><span style="color:red;" id="sp4"></span>
          <br>        
     <input type="text" id="username" name="username" onkeyup="clearmsg('sp5')"  class="form-control form-control-lg" placeholder="enter your username" /><span style="color:red;" id="sp5"></span>
           <br>     
   <input type="password" id="password" name="password" onkeyup="clearmsg('sp6')" class="form-control form-control-lg" placeholder="enter your password" /><span style="color:red;" id="sp6"></span>
   <br>
   <br>
   ...
   <input type="file" id="file" name="image">
    ...
    {
      document.getElementById("sp5").innerHTML="please enter your username";
    return false;
    }
    if(password==null || password=="")
    {
      document.getElementById("sp6").innerHTML="please enter your pasword";
      return false;
    }
   return true;
  }
